...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/matejnevlud/github/golden-lobster/generated/prisma-client-neon",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "postgresql://neondb_owner:Hf6mP1RLMjcT@ep-curly-hill-a2rgtz38.eu-central-1.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  ...
  "inlineSchemaHash": "e9b39dfd52328c7664d00ceb8e65d07c6725228d666a0ddfbd47920ae98e33c7",
  "copyEngine": true
}
...
path.join(process.cwd(), "generated/prisma-client-neon/libquery_engine-darwin-arm64.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-1.1.x.so.node");
path.join(process.cwd(), "generated/prisma-client-neon/libquery_engine-debian-openssl-1.1.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "generated/prisma-client-neon/libquery_engine-linux-musl-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-arm64-openssl-3.0.x.so.node");
path.join(process.cwd(), "generated/prisma-client-neon/libquery_engine-linux-musl-arm64-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated/prisma-client-neon/schema.prisma")
